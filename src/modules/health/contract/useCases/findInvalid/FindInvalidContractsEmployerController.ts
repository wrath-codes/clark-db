...
export class FindInvalidContractsEmployerController {
  async handle(request: Request, response: Response) {
    ...
    const findInvalidContractsEmployerUseCase = new FindInvalidContractsEmployerUseCase();

    const contracts = await findInvalidContractsEmployerUseCase.execute(id_employer);
